...
<div id="about" class="about">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-l2 atout">                    
                        <p>
                            <span class="num">16</span> Hectares de forêts
                        </p>        
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-l2 atout1">                    
                        <p>
                            <span class="num">500</span> Producteurs
                        </p>        
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-l2 atout2">                    
                        <p>
                          <span class="num"> 12 </span> Machines
                        </p>        
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-l2 atout3">                    
                        <p>
                          <span class="num"> O8 </span> Experts
                        </p>        
                </div>
            </div>
        </div>
